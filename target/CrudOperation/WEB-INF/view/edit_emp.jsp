    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto mb-auto mb-2 mb-lg-0">
             ...
             <li class="nav-item">
                 <a class="nav-link" href="addEmp">Update Emp</a>
             </li>
          </ul>
        </div>
     </nav>
                     ...
                     <input type="hidden" name="id" value="${employee.id}">
                       ...
                       <div class="md-3">
                          <label>Enter Address1</label><input type="text" 
                                 name="address1" class="form-control" value="${employee.address1}">
                       </div>
                       <div class="md-3">
                          <label>Enter Email</label><input type="text" 
                                 name="email" class="form-control" value="${employee.email}">
                       </div>
                       <div class="md-3">
                          <label>Enter Password</label><input type="text" 
                                 name="password" class="form-control" value="${employee.password}">
                       </div>
                       <div class="md-3">
